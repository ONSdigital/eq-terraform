...
credstash --table $table put -k $key "EQ_SECRET_KEY" "@secrets/eq-secret-key.txt" -a
credstash --table $table put -k $key "EQ_SERVER_SIDE_STORAGE_DATABASE_USERNAME" "@secrets/eq-database-username.txt" -a
credstash --table $table put -k $key "EQ_SERVER_SIDE_STORAGE_DATABASE_PASSWORD" "@secrets/eq-database-password.txt" -a

credstash --table $table put -k $key "EQ_RABBITMQ_USERNAME" "@secrets/eq-rabbitmq-username.txt" -a
credstash --table $table put -k $key "EQ_RABBITMQ_PASSWORD" "@secrets/eq-rabbitmq-password.txt" -a
